...
const keys:Record<string,KeyType>={
    ...
    gui:{
        ...
        global:{
            ...
            fontFamily:K, //computed font family
        },
        gpspage:{
            pageNumber:K,
        },
    ...
    properties: {
        ...
        centerColor: new Property('black','Crosshair color',PropertyType.COLOR,undefined,"the color being used to draw the crosshair at map center"),
        centerSize: new Property(55,'Crosshair size',PropertyType.RANGE,[10,300],"the size in pixel of the crosshair at map center"),
        centerWidth: new Property(2,"Crosshair width",PropertyType.RANGE,[1,30],'The line width of the crosshair at map center'),
