...
const settingsSections={
    ...
    Layout2:     [keys.properties.localAlarmSound, keys.properties.mobMinZoom,keys.properties.cancelTop,keys.properties.buttonCols,keys.properties.style.useHdpi,keys.properties.clickTolerance],
