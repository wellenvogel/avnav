...
#define GdalCode "{{7F10DD4A-3D5F-4A43-B1B5-A9D50318FE72}"
#define GdalDir "gdal"
#define GdalPythonMSI "GDAL-1.11.4.win32-py2.7.msi"
#define GdalPythonCode "{{19294F14-A8EF-47D8-8CA1-EE6311C7984B}"
