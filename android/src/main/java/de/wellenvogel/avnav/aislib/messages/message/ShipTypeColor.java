...
import de.wellenvogel.avnav.aislib.messages.message.ShipTypeCargo.ShipType;
...
public enum ShipTypeColor {
    ...
    private static final HashMap<ShipType, ShipTypeColor> REVERSE_LOOKUP = new HashMap<ShipType, ShipTypeColor>();
