...
(function(factory) {
    ...
    Plugin.prototype.getRelativePosition = function(node, e) {
        return (e.pageX || e.originalEvent.clientX || ((e.originalEvent.touches && e.originalEvent.touches.length > 0)?e.originalEvent.touches[0].clientX:0) || (e.currentPoint? e.currentPoint.x:0)) - this.getPositionFromNode(node);
    };
