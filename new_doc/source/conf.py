...
project = u'av-stest'
copyright = u'2019, andreas vogel [wellenvogel]'
author = u'andreas vogel [wellenvogel]'
...
html_style = "avnav.css"

html_short_title="AvNav Dokumentation"
...
latex_documents = [
    (master_doc, 'av-stest.tex', u'av-stest Documentation',
     u'andreas vogel {[}wellenvogel{]}', 'manual'),
]
...
man_pages = [
    (master_doc, 'av-stest', u'av-stest Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'av-stest', u'av-stest Documentation',
     author, 'av-stest', 'One line description of project.',
     'Miscellaneous'),
]
