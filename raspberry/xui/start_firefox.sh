...
do
 ...
 MOZ_USE_XINPUT2=1 firefox --profile $PROFILE --class=AvNavFirefox 'http://localhost:8080/viewer/avnav_viewer.html?fullscreen=false&dimm=server:dimm&defaultSettings=.*localFirefox&preventAlarmSound=true' &
 ffpid=$!
 echo "ffpid=$ffpid"
 panelSize=""
