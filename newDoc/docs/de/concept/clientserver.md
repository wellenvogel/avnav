...
Die zweite Komponente ist der Client, also beispielsweise das Gerät, das der Benutzer zur Bedienung in der Hand hält. Der Client benötigt keine eigene Navigationssoftware mehr. Ein handelsüblicher Webbrowser (wie Safari, Chrome oder Firefox) reicht völlig aus. Man verbindet sich mit dem WiFi-Netzwerk, welches der Server bereitstellt und ruft auf dem Tablet oder Smartphone einfach die Webadresse des AvNav-Servers auf. Sofort liegt die vollständige Seekarte samt Instrumentenanzeige vor.

Dieses Konzept bietet im Bordalltag unschlagbare Vorteile. Der offensichtlichste ist die Ausfallsicherheit: wenn das Tablet im Cockpit durch Regenwasser unbedienbar wird oder wegen eines leeren Akkus ausgeht, läuft das System unter Deck einfach weiter. Die Route bleibt aktiv, der Autopilot steuert weiter seinen Kurs und die Ankerwache bleibt scharf. Es kann jederzeit ein beliebiges anderes Gerät eingesetzt werden, etwa ein Smartphone. Man verbindet es über das bordeigene WLAN mit AvNav und navigiert genau dort weiter, wo das Tablet aufgehört hat. Zudem können mehrere Crewmitglieder gleichzeitig mit unterschiedlichen Geräten auf das System zugreifen – der Skipper plant am Kartentisch auf dem Laptop die Route für den nächsten Tag, während der Rudergänger draußen auf dem Tablet den aktuellen Kurs überwacht. Alle sehen dabei denselben, stets synchronen Datenbestand.